...
fall_counter = 0
music_started = False
paused = False  # Novo controle de pausa
...
def update():
    ...
    if start_screen or game_over or paused:
        return
...
def draw():
    ...
    if paused:
        screen.draw.text("PAUSADO", center=(WIDTH//2, HEIGHT//2), fontsize=40, color="yellow")
    elif game_over:
...
def on_key_down(key):
    global current_piece, start_screen, game_over, score, grid, paused
